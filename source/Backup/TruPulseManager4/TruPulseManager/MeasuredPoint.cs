...
{
    [Serializable()]
    public class MeasuredPoint : IComparable, ISerializable
    {
        ...
        {
            info.AddValue("MeasuredValues", MeasuredValues);
            info.AddValue("StationID", StationID);
        ...
        {
            MeasuredValues = (HVMessage)info.GetValue("MeasuredValues", typeof(HVMessage));
            StationID = (int)info.GetValue("StationID", typeof(int));
            ...
            Selected = (bool)info.GetValue("Selected", typeof(bool));
